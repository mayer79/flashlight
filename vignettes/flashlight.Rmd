...
### Variable contribution breakdown for single observations and SHAP

Instead of studying global variable importance and effects, there are different techniques to entangle how a *single prediction* can be decomposed into additive effects of input variables: LIME, LIVE, SHAP and breakdown, see [@molnar] and [@gosiewska] for an overview. The `flashlight` package currently supports the breakdown method as well as approximate SHAP.
