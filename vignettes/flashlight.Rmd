...
Now let's study variable importance of the explainers. By default, it is shown with respect to the first metric in the explainers. In our case, its the root-mean-squared error. We additionally pass the variables we are interested in.
